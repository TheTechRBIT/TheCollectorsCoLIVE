...
namespace TheCollectorsCoLIVE.Controllers
{
    public class BaseballCardsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BaseballCardID,CardNumber,TeamID,PlayerID,CoachID,PlayerNumber,PositionID,ManufacturerID,CardYear,CardComments,CardImage ")] BaseballCard baseballCard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BaseballCardID,CardNumber,TeamID,PlayerID,CoachID,PlayerNumber,PositionID,ManufacturerID,CardYear,CardComments,CardImage")] BaseballCard baseballCard)
        {
            if (ModelState.IsValid)
            {
